/**
 * Shared query functions called by both server components (directly)
 * and route handlers (via HTTP). Keeps the DB logic in one place.
 */
...
export function getFilterOptions(): FilterOptions {
  ...
  return { states, years, instTypes, institutions };
}
